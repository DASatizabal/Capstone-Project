...
export async function optimizeImageBuffer(
  ...
  console.warn('Image optimization not implemented. Consider installing sharp for production use.');
  return buffer;
}
...
export function getOptimizedFilename(originalName: string, suffix: string = 'optimized'): string {
